...
/**
 * <p>
 * This example shows how enforcing SPR.VPPD: ("Encapsulate all dangerous data
 * returning methods with a validation function") helps to definitelly secure an
 ...
 * vulnerability is reported by both BD.SECURITY.TDSQL and SPR.VPPD.
 ...
 * the SQL statement. SPR.VPPD tell us that <code>HttpServletRequest</code> is
 ...
 * SPR.VPPD errors are still reported. One could leave the code as it is as the
 * fix succesfully prevents any attack on the existing code. To see how this
 ...
 * completelly delete the "Accounts" table (or any other table) from the
 * database.
 * <p>
