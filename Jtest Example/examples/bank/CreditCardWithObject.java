 ...
 * the class. Jtest automatically uses the CreditCardWithObject sample object
 * defined by user to generate a valid credit card object.
 * 
 * @see CreditCard
 */
public class CreditCardWithObject {
     ...
     */
    public CreditCardWithObject(int balance, int id, String securityNumber,
